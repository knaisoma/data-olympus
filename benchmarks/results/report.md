...
On **semantic** (paraphrase) queries, data-olympus achieves recall=0.036, ndcg=0.021. This is the category where dense vector search has the largest advantage, because paraphrases lack the keyword overlap that the BM25-based index relies on.
